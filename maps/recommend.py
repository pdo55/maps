...
def group_by_centroid(restaurants, centroids):
    ...
    # BEGIN Question 4
    "*** YOUR CODE HERE ***"
    return group_by_first([[find_closest(restaurant_location(r), centroids), r] \
...
def k_means(restaurants, k, max_updates=100):
    ...
    while old_centroids != centroids and n < max_updates:
        ...
        # BEGIN Question 6
        "*** YOUR CODE HERE ***"
        centroids = [find_centroid(cluster) for cluster \
            in group_by_centroid(restaurants, old_centroids)]
        # END Question 6
        n += 1
    return centroids
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    "*** YOUR CODE HERE ***"
    return find_predictor(user, reviewed, max(feature_fns, \
            key=lambda x: find_predictor(user, reviewed, x)[1]))[0]
    # END Question 8
